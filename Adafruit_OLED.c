...
*/
    ...
    MAP_SPICSEnable(GSPI_BASE); // enable OLED for communication

    GPIOPinWrite(GPIOA1_BASE, 0x2, 0); //set dc to low for command

    GPIOPinWrite(GPIOA2_BASE, 0x2, 0); //set OLEDCS to low
    ...
    GPIOPinWrite(GPIOA2_BASE, 0x2, 0x2); //set OLEDCS to high
...
*/
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x2, 0x2); //set dc to high for data
    ...
    GPIOPinWrite(GPIOA2_BASE, 0x2, 0x2); //set OLEDCS to low
